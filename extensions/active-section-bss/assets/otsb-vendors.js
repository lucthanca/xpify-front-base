if (typeof window.Alpine === 'undefined' && window.Eurus === undefined) {
  /** intersect 3.10.5 */
  ...
  requestAnimationFrame(() => {
    (() => {
      ...
      var et = new MutationObserver(Xe), tt = !1;

      function rt() {
        et.observe(document, {subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0}), tt = !0
      }
...
` : ""}`, t), setTimeout(() => {
      ...
      function ne(e, t, r) {
        if (t = Array.from(t), e._x_virtualDirectives) {
          let o = Object.entries(e._x_virtualDirectives).map(([a, c]) => ({name: a, value: c})), s = ft(o);
      ...
      var Ee = (e, t) => ({name: r, value: n}) => (r.startsWith(e) && (r = r.replace(e, t)), {name: r, value: n}),
        Se = e => e;

      function tr(e = () => {
      }) {
        return ({name: t, value: r}) => {
          let {name: n, value: i} = or.reduce((o, s) => s(o), {name: t, value: r});
      ...
      function xn(e, t) {
        return ({name: r, value: n}) => {
          let i = r.match(sr()), o = r.match(/:([a-zA-Z0-9\-:]+)/), s = r.match(/\.[^.\]]+(?=[^\]]*$)/g) || [],
            a = t || e[r] || r;
          return {
            type: i ? i[1] : null,
            value: o ? o[1] : null,
      ...
      function yn(e, t) {
        let r = Ae.indexOf(e.type) === -1 ? pt : e.type, n = Ae.indexOf(t.type) === -1 ? pt : t.type;
      ...
      function On(e, t, r) {
        ...
        let s = !t.includes("opacity") && !t.includes("scale"), a = s || t.includes("opacity"),
          c = s || t.includes("scale"), l = a ? 0 : 1, u = c ? ae(t, "scale", 95) / 100 : 1, p = ae(t, "delay", 0),
          y = ae(t, "origin", "center"), N = "opacity, transform", W = ae(t, "duration", 150) / 1e3,
          pe = ae(t, "duration", 75) / 1e3, f = "cubic-bezier(0.4, 0.0, 0.2, 1)";
      ...
      function mr(e, t, r = {}) {
        e._x_transition || (e._x_transition = {
          ...
          in(n = () => {
            ...
            Me(e, t, {during: this.enter.during, start: this.enter.start, end: this.enter.end}, n, i)
          },
          out(n = () => {
          }, i = () => {
          }) {
            Me(e, t, {during: this.leave.during, start: this.leave.start, end: this.leave.end}, n, i)
          }
        })
      }
      ...
      function Me(e, t, {during: r, start: n, end: i} = {}, o = () => {
      }, s = () => {
      }) {
      ...
      var Mr = Object.freeze({}), ss = Object.freeze([]);
      var bt = Object.assign;
      var Bn = Object.prototype.hasOwnProperty, le = (e, t) => Bn.call(e, t), L = Array.isArray,
        X = e => Nr(e) === "[object Map]";
      var Kn = e => typeof e == "string", ke = e => typeof e == "symbol", ue = e => e !== null && typeof e == "object";
      var zn = Object.prototype.toString, Nr = e => zn.call(e), vt = e => Nr(e).slice(8, -1);
      var De = e => Kn(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
      var Ie = e => {
          let t = Object.create(null);
          return r => t[r] || (t[r] = e(r))
        }, Vn = /-(\w)/g, as = Ie(e => e.replace(Vn, (t, r) => r ? r.toUpperCase() : "")), Hn = /\B([A-Z])/g,
        cs = Ie(e => e.replace(Hn, "-$1").toLowerCase()), wt = Ie(e => e.charAt(0).toUpperCase() + e.slice(1)),
        ls = Ie(e => e ? `on${wt(e)}` : ""), Et = (e, t) => e !== t && (e === e || t === t);
      var St = new WeakMap, fe = [], M, U = Symbol("iterate"), At = Symbol("Map key iterate");
      ...
      var Jn = yt("__proto__,__v_isRef,__isVue"),
        $r = new Set(Object.getOwnPropertyNames(Symbol).map(e => Symbol[e]).filter(ke)), Zn = $e(), Qn = $e(!1, !0),
        Xn = $e(!0), ei = $e(!0, !0), Le = {};
      ...
      function Br(e = !1) {
        return function (r, n, i, o) {
          ...
          let a = L(r) && De(n) ? Number(n) < r.length : le(r, n), c = Reflect.set(r, n, i, o);
          return r === _(o) && (a ? Et(i, s) && j(r, "set", n, i, s) : j(r, "add", n, i)), c
        }
      }

      function oi(e, t) {
        let r = le(e, t), n = e[t], i = Reflect.deleteProperty(e, t);
      ...
      var Kr = {get: Zn, set: ni, deleteProperty: oi, has: si, ownKeys: ai}, zr = {
          get: Xn, set(e, t) {
            return console.warn(`Set operation on key "${String(t)}" failed: target is readonly.`, e), !0
          }, deleteProperty(e, t) {
            return console.warn(`Delete operation on key "${String(t)}" failed: target is readonly.`, e), !0
          }
        }, hs = bt({}, Kr, {get: Qn, set: ii}), _s = bt({}, zr, {get: ei}), Ct = e => ue(e) ? je(e) : e,
        Rt = e => ue(e) ? Fr(e) : e, Mt = e => e, Fe = e => Reflect.getPrototypeOf(e);

      function Be(e, t, r = !1, n = !1) {
        e = e.__v_raw;
        let i = _(e), o = _(t);
        t !== o && !r && T(i, "get", t), !r && T(i, "get", o);
        let {has: s} = Fe(i), a = n ? Mt : r ? Rt : Ct;
      ...
      function qr(e, t) {
        t = _(t);
        let r = _(this), {has: n, get: i} = Fe(r), o = n.call(r, e);
      ...
      function Ur(e) {
        let t = _(this), {has: r, get: n} = Fe(t), i = r.call(t, e);
      ...
      function Wr() {
        let e = _(this), t = e.size !== 0, r = X(e) ? new Map(e) : new Set(e), n = e.clear();
        return t && j(e, "clear", void 0, void 0, r), n
      }

      function Ve(e, t) {
        return function (n, i) {
          let o = this, s = o.__v_raw, a = _(s), c = t ? Mt : e ? Rt : Ct;
      ...
      function He(e, t, r) {
        return function (...n) {
          let i = this.__v_raw, o = _(i), s = X(o), a = e === "entries" || e === Symbol.iterator && s,
            c = e === "keys" && s, l = i[e](...n), u = r ? Mt : t ? Rt : Ct;
      ...
      var Gr = {
        get(e) {
          ...
          return ze(this)
        }, has: Ke, add: Vr, set: qr, delete: Ur, clear: Wr, forEach: Ve(!1, !1)
      }, Yr = {
        get(e) {
          return Be(this, e, !1, !0)
        }, get size() {
          return ze(this)
        }, has: Ke, add: Vr, set: qr, delete: Ur, clear: Wr, forEach: Ve(!1, !0)
      }, Jr = {
        get(e) {
          return Be(this, e, !0)
        }, get size() {
        ...
        }, add: F("add"), set: F("set"), delete: F("delete"), clear: F("clear"), forEach: Ve(!0, !1)
      }, Zr = {
        get(e) {
          ...
          return Ke.call(this, e, !0)
        }, add: F("add"), set: F("set"), delete: F("delete"), clear: F("clear"), forEach: Ve(!0, !0)
      ...
      var li = {get: qe(!1, !1)}, gs = {get: qe(!1, !0)}, ui = {get: qe(!0, !1)}, xs = {get: qe(!0, !0)};
      ...
      var Lr = new WeakMap, ti = new WeakMap, jr = new WeakMap, ri = new WeakMap;
      ...
      x("id", e => (t, r = null) => {
        let n = Xr(e, t), i = n ? n._x_ids[t] : Pt(t);
        return r ? `${t}-${i}-${r}` : `${t}-${i}`
      });
      x("el", e => e);
      ...
      d("modelable", (e, {expression: t}, {effect: r, evaluateLater: n}) => {
        let i = n(t), o = () => {
          let l;
          return i(u => l = u), l
        }, s = n(`${t} = __placeholder`), a = l => s(() => {
        }, {scope: {__placeholder: l}}), c = o();
        a(c), queueMicrotask(() => {
          if (!e._x_model) return;
          e._x_removeModelListeners.default();
          let l = e._x_model.get, u = e._x_model.set;
          r(() => a(l())), r(() => u(o()))
        })
      });
      ...
      d("model", (e, {modifiers: t, expression: r}, {effect: n, cleanup: i}) => {
        let o = g(e, r), s = `${r} = rightSideOfExpression($event, ${r})`, a = g(e, s);
        var c = e.tagName.toLowerCase() === "select" || ["checkbox", "radio"].includes(e.type) || t.includes("lazy") ? "change" : "input";
        let l = yi(e, t, r), u = de(e, c, t, y => {
          a(() => {
          }, {scope: {$event: y, rightSideOfExpression: l}})
        });
      ...
      Re(() => `[${E("init")}]`);
      d("init", $((e, {expression: t}, {evaluate: r}) => typeof t == "string" ? !!t.trim() && r(t, {}, !1) : r(t, {}, !1)));
      ...
      d("for", (e, {expression: t}, {effect: r, cleanup: n}) => {
        let i = Si(t), o = g(e, i.items), s = g(e, e._x_keyExpression || "index");
      ...
      function Ei(e, t, r, n) {
        ...
        r(s => {
          ...
          for (let f = 0; f < u.length; f++) {
            let h = u[f], b = c.indexOf(h);
            if (b === -1) c.splice(f, 0, h), p.push([pe, f]); else if (b !== f) {
              let v = c.splice(f, 1)[0], S = c.splice(b - 1, 1)[0];
          ...
          for (let f = 0; f < p.length; f++) {
            ...
            let S = l[b], G = u[b], me = document.importNode(o.content, !0).firstElementChild;
            C(me, A(S), o), m(() => {
              v.after(me), w(me)
      ...
      Z(Ee("@", Se(E("on:"))));
      d("on", $((e, {value: t, modifiers: r, expression: n}, {cleanup: i}) => {
        let o = n ? g(e, n) : () => {
        };
