...
import RelatedProducts from '~/components/SectionDetails/RelatedProducts/index.jsx';
...
const SectionFullpageDetails = props => {
  ...
  return (
    <Page
      ...
      compactTitle
      primaryAction={{content: 'Manage Section', onAction: handleShowPopup}}
      secondaryActions={[
        {
          content: 'View in demo site',
          icon: ViewIcon,
          url: section?.demo_link,
          disabled: !section?.demo_link,
