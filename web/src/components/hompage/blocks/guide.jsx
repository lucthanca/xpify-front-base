      ...
      <Box padding={400} paddingBlockEnd={200}>
        <BlockStack gap={200}>
          <InlineGrid columns='1fr auto'>
            ...
            {/*<Button variant='plain' onClick={() => handleToggle()} icon={<Icon source={open ? ChevronUpIcon : ChevronDownIcon} tone='base' />} />*/}
          </InlineGrid>
          <Text variant='bodyMd'>
          ...
          <Collapsible open={open} id='guide' transition={{ duration: '300ms', timingFunction: 'ease-in-out' }} expandOnPrint>
            <CollapsibleGuide
              options={{
                ...
                content: (
                  <Button variant='primary' url={urlEmbedApp} target='_blank'>
                    Go to themes
                  </Button>
                ),
            ...
            <CollapsibleGuide
              options={{
                ...
                content: (
                  <Button variant='primary' url={urlEditTheme} target='_blank'>
                    Go to theme editor
                  </Button>
                ),
